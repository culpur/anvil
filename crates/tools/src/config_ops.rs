...
// =============================================================================
// Agent implementation (kept in this module since it's referenced by run_agent)
// =============================================================================
...
impl ToolExecutor for SubagentToolExecutor {
    fn execute(&mut self, tool_name: &str, input: &str) -> Result<String, ToolError> {
        ...
        crate::execute_tool(tool_name, &value).map_err(ToolError::new)
    }
}

fn tool_specs_for_allowed_tools(allowed_tools: Option<&BTreeSet<String>>) -> Vec<crate::ToolSpec> {
    mvp_tool_specs()
        .into_iter()
...
fn search_tool_specs(query: &str, max_results: usize, specs: &[crate::ToolSpec]) -> Vec<String> {
